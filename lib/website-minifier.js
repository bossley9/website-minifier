...
export default {
  ...
  config: {
    ...
    InlineJs: {
      title: "Inline JS",
      description: "Inlines, transpiles and minifies any external scripts into the HTML file",
      type: 'boolean',
      default: true,
      order: 5
    },
  ...
  //     editor.onDidSave( () => {
  //       atom.notifications.addWarning("save");
  //     })
  //   })
  ...
  minify() {
    ...
    // if ActiveTextEditor is invalid
      ...
      atom.notifications.addError("website-minify: Attempt to minify a \
      non-file window.");
      atom.beep();
    }
  }
